-- MIGRATION ONLY SCRIPT
-- This script migrates all data from old tables to new consolidated tables
-- Run this first, then test your application before running the cleanup script
...
-- Now test your application to ensure everything works.
-- If everything works correctly, you can run the cleanup script to drop old tables.
