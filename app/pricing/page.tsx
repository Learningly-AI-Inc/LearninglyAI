...
export default function PricingPage() {
  ...
  const handleUpgrade = async (planId: string) => {
    console.log('Pricing page button clicked!', { planId, user: !!user });
      ...
      <div className="container mx-auto px-4 md:px-6 py-16 md:py-24">
        {isTestMode && (
          <motion.div
            ...
            className="mb-6 rounded-xl border border-yellow-500/30 bg-yellow-500/10 text-yellow-200 px-6 py-3 text-sm max-w-6xl mx-auto"
          >
